...
import trupp.ware.truppware.module.modules.MOVEMENT.Speed;
...
public class Manager {
    ...
    public void InitializeModules() {
        ...
        modules.add(new TargetRing());
        modules.add(new TargetCircle());
        modules.add(new BoxESP());
        modules.add(new DamageTag());
        modules.add(new RiceHat());
